/**
 * Web Audio API synthesizer for instant bell / notification chimes
 * Works reliably in browsers without external assets.
 */
class SoundService {
